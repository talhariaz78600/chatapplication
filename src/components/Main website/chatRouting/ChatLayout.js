                            ...
                            <div className="h-full w-full px-3 pb-4 overflow-y-auto  ">
                                <ul className="space-y-2 font-medium my-3">
                                    {myconnection && myconnection.map((chatobj, index) => (
                                        <div key={index} >
                                            <li className={`flex ${chatobj.chatId === roomID ? "bg-cyan-100" : ""} items-center justify-between my-2 hover:bg-gray-200 hover:shadow-none shadow-md  rounded-md px-2 py-3 cursor-pointer`} onClick={()=>{
                                                ...
                                                <div onClick={async () => {
                                                    ...
                                                    <div>
                                                        <img src={chatobj.ProfileImageUrl} alt="img" className="w-8 h-8 rounded-3xl " />
                                                    </div>
                                                    <span>
                                                        {chatobj.username}
                                                    </span>
